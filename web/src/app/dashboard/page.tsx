          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-5 items-start">
              ...
              <div className="lg:col-span-5 space-y-4">
                <Card className="p-5 space-y-4 border-2 border-border bg-card/90 backdrop-blur-sm shadow-sm">
                  <div className="flex items-center justify-between border-b border-border pb-3">
                    <h3 className="text-xs sm:text-sm font-bold uppercase tracking-wider text-muted-foreground font-mono flex items-center gap-2">
                      <ShieldCheck className="w-4 h-4 text-foreground" />
                      Autonomous SLA Protection
                    </h3>
                    <Badge variant="success" className="text-xs font-mono font-bold">ENFORCED</Badge>
                  </div>

                  <div className="grid grid-cols-2 gap-3">
                    <div className="p-3 bg-muted/30 border-2 border-border">
                      <div className="text-2xl sm:text-3xl font-black font-mono text-foreground">38.4s</div>
                      <div className="text-xs font-mono text-muted-foreground uppercase mt-1">Mean Time To Recover</div>
                    </div>
                    <div className="p-3 bg-muted/30 border-2 border-border">
                      <div className="text-2xl sm:text-3xl font-black font-mono text-emerald-600 dark:text-emerald-400">100%</div>
                      <div className="text-xs font-mono text-muted-foreground uppercase mt-1">Safety Gate Accuracy</div>
                    </div>
                  </div>

                  <div className="space-y-2 pt-1 text-xs sm:text-sm text-foreground/90 font-sans leading-relaxed">
                ...
                <Card className="p-4 border-2 border-border bg-card/90 backdrop-blur-sm flex items-center justify-between shadow-sm">
                  <div>
                    <h4 className="text-xs sm:text-sm font-bold font-mono text-foreground uppercase">Active Decision Trace</h4>
          ...
          <div className="space-y-5">
            ...
            {traces && traces.length > 1 && (
              <div className="flex items-center gap-3 p-3 border-2 border-border bg-card/90 backdrop-blur-sm">
                <span className="text-xs font-mono font-bold text-muted-foreground uppercase px-1">Select Incident Trace:</span>
        ...
        {activeTab === "postmortems" && (
          <div className="space-y-5">
            ...
            {postmortems && postmortems.length > 1 && (
              <div className="flex items-center gap-3 p-3 border-2 border-border bg-card/90 backdrop-blur-sm">
                <span className="text-xs font-mono font-bold text-muted-foreground uppercase px-1">Select SRE Report:</span>
                <div className="flex items-center gap-2 overflow-x-auto">
                  {postmortems.map((p) => (
                    <Button
                      key={p.report_id}
