...
export function getCanonicalTraceStages(trace?: DecisionTrace | null): TraceStageItem[] {
  ...
  return [
    ...
    },
    {
      ...
      step: 3,
      num: "03",
      title: "Gemini 3.5 Pro Reasoning",
      actor: "Decision Agent",
      icon: Brain,
      badge: "MODEL ARMOR SCREENED",
      badgeVariant: "brutalist",
      summary: `Gemini 3.5 Pro synthesized current telemetry, historical postmortems, and target rollout configuration to decide: ${decision}.`,
