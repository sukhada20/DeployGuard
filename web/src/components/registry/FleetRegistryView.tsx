...
const DEFAULT_AGENTS: AgentRegistryModel[] = [
  ...
  },
  {
    ...
    tools: ["gemini-3.5-pro", "model_armor_screen", "deterministic_policy_check"],
    status: "ACTIVE",
    created_at: "2026-08-29T10:00:00Z",
    last_heartbeat: "2026-08-30T13:45:00Z",
    description: "Evaluates incident root cause via Gemini 3.5 Pro reasoning, screened by Model Armor, and strictly enforced through 5 deterministic code gates.",
  },
  {
  ...
  },
  {
    ...
    tools: ["gemini-3.5-flash", "markdown_export", "firestore.documents.create"],
    status: "ACTIVE",
    created_at: "2026-08-29T10:00:00Z",
    last_heartbeat: "2026-08-30T13:45:00Z",
