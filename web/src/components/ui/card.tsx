...
const Card = React.forwardRef<
  HTMLDivElement,
  React.HTMLAttributes<HTMLDivElement> & { variant?: "default" | "brutalist" | "muted" }
...
>(({ className, ...props }, ref) => (
  <h3
    ref={ref}
    className={cn("font-mono text-xs font-bold tracking-tight uppercase text-foreground", className)}
    {...props}
  />
));
